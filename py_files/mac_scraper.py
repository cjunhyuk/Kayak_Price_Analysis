...
#     sections_list = [value.text for value in sections if len(value.text) != 0]
...
#     stops_list = [stop.text[0].replace('n','0') for stop in stops if len(stop.text) != 0]
#     a_stop_list = stops_list[::2]
#     b_stop_list = stops_list[1::2]

#     xp_stops_cities = '//div[@class="section stops"]/div[2]'
#     stops_cities = driver.find_elements(By.XPATH, xp_stops_cities)
#     stops_cities_list = [stop.text for stop in stops_cities if len(stop.text) != 0]
